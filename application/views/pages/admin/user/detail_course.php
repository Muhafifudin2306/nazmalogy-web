...
<body id="body-pd">
    ...
    <!-- Content -->
    <?php include(APPPATH . 'views/components/admin/user/detail_course.php'); ?>
    <!-- Content -->
    ...
    <script>
        ...
        function togglePlayPause() {
            if (isPlaying) {
                player.pauseVideo();
                document.getElementById('playPauseButton').innerHTML = '<i class="bi bi-play-fill"></i>';
                isPlaying = false;
            } else {
                player.playVideo();
                document.getElementById('playPauseButton').innerHTML = '<i class="bi bi-pause-fill"></i>';
                isPlaying = true;
            }
        }
