...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url('assets/node_modules/datatables.net-dt/css/jquery.dataTables.css'); ?>">
...
<body id="body-pd">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        copyButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    icon: 'success',
                    title: '<h3 class="text-black fw-bold">' + 'Email Tersalin' +
                        '</h3>',
    ...
    $(document).ready(function() {
        ...
        $('#recently-logged-in-users').DataTable({
            "pageLength": 3,
            "style": "font-size: 0.8rem;"
        });
        $(document).ready(function() {
