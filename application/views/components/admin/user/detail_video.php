...
<div class="space-top">
    <div class="d-flex justify-content-between align-items-center">
        <div class="title">
            <h3 class="text-2"><?= $id_video->title ?></h3>
                    ...
                    <?php if ($has_relation) : ?>
                        <?php if (empty($feedback->rating)) : ?>
                            <form action="<?= site_url('userBranch/classpath/save_feedback') ?>" method="post">
                                ...
                                <div class="mb-3 p-2">
                                    <label for="rating" class="text-lg text-2 form-label">Berikan Rating</label>
                                ...
                                <div class="mb-3 p-2">
                                    <label for="feedback" class="text-lg text-2 form-label">Berikan Masukan dan Saran</label>
                                    <textarea rows="4" name="feedback" class="form-control" placeholder="Leave a comment here"></textarea>
                                </div>
                                <button class="btn btn-primary btn-blue-1 w-100"> Kirim Feedback</button>
                            </form>
                        <?php else : ?>
                            <div class="feedback p-2 p-md-3 border">
                                <div class="d-flex justify-content-between py-2">
                                    ...
                                    <div class="action-btn">
                                        <button class="btn btn-primary btn-blue-1 p-1 px-3 text-white text-lg" data-bs-toggle="modal" data-bs-target="#FeedbackModal"> <i class="bi bi-pencil-square"></i> Edit</button>
                                    </div>
                                </div>
            ...
            <div class="right-content mb-5 pb-5">
                ...
                foreach ($playlists as $playlist) { ?>
                    ...
                    <?php foreach ($playlist->videos as $video) { ?>
                        ...
                        <?php endif ?>
                        <div class="list-course pt-1">
                            <div class="bg-white gap-2 rounded d-flex justify-content-between p-3 border">
                                ...
                                <?php if ($video->id == $id_video->id) : ?>
                                    <div class="time-course fw-bold fs-7 d-flex justify-content-end" id="duration">
                                        <?php if ($video->status == 1) : ?>
                                            <i class="bi bi-check-all text-success fs-4 fw-bold"></i>
                                        <?php else : ?>
                                            <?= $video->duration ?>min
