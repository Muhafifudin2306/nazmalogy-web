...
<div class="space-top">
    <div class="row">
        <div class="col-md-7">
            <div class="d-flex justify-content-between" data-aos="fade-up" data-aos-duration="700">
                ...
                <a href="<?= site_url('adminRoot/setting/add_testimony') ?>"><button
                        class="btn btn-success btn-blue-1 fw-bold fs-8">+ Tambah </button></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        <?php if ($row->status == 1) : ?>
                                        <span class="text-success fw-bold fs-8"> <i class="bi bi-check-all"></i>
                                            active</span>
                                        <?php else : ?>
                                        <span class="text-danger fw-bold fs-8"> <i class="bi bi-x"></i>
                                            non-active</span>
                                        <?php endif ?>
                                    </div>
                                ...
                                <td>
                                    <div class="d-flex gap-2 justify-content-center">
                                        ...
                                        <button onclick="testimonyDeleteConfirmation(<?php echo $row->id; ?>)"
                                            class="btn btn-danger btn-orange-1 text-white fs-7">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-primary btn-blue-1 copy-email fs-7"
                                            data-email="<?= $row->email; ?>"><i
                                                class="bi bi-clipboard-fill fs-7"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                <button onclick="userDeleteConfirmation(<?php echo $row->id; ?>)"
                                    class="btn btn-danger btn-orange-1 text-white fs-7">
                                    <span class='text-white'><i class='bi bi-trash3-fill fs-7'></i></span>
                                </button>
                            </div>
    ...
    <div class="d-flex justify-content-lg-start">
        <h5 class="text-2">Data User LoggedIn</h5>
    </div>

    <div class="mb-5 py-3">
        <div class="bg-white p-5 border mb-5">
            <table id="recently-logged-in-users" class="table display">
                <thead>
                    <tr>
                        <th class="text-center fs-7" scope="col">No</th>
                        <th class="text-center fs-7" scope="col">Nama Lengkap</th>
                        <th class="text-center fs-7" scope="col">Email</th>
                        <th class="text-center fs-7" scope="col">Last Login</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
        $no = 1;
        foreach ($logged_in_users as $row) {
        ?>
                    <tr>
                        <td class="text-center fs-7"><?php echo $no++ ?></td>
                        <td class="text-center fs-7"><?php echo $row->name; ?></td>
                        <td class="text-center fs-7"><?php echo $row->email; ?></td>
                        <td class="text-center fs-7"><?php echo $row->last_login; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
