        ...
        <div class="py-3">
            <div class="row">
                <div class="col-lg-5 col-md-5">
                    ...
                    <p class="text-white fs-8" align="justify">Bersama NaZMaLogy Berinovasi Mewujudkan Mimpi, Ubah Impian Menjadi Kenyataan dengan Platform
                        Pembelajaran Interaktif dan Inovatif.
                    </p>
                </div>
                <div class="col-lg-2 col-md-3">
                    <h6 class="mt-4 mb-3 fw-bold text-white">Shortcut Link</h6>
                    <div class="px-3">
                ...
                <div class="col-lg-2 d-none d-lg-inline">
                    ...
                    <div class="px-3">
                        <div class="link-footer mb-2">
                            <a class="text-white text-decoration-none" href="<?= site_url('front/#testimoni') ?>">
                                <span class="fs-8">
                                    Testimoni
                                </span>
                            </a>
                        ...
                        <div class="link-footer mb-2">
                            <a class="text-white text-decoration-none" href="<?= site_url('front/#subscribe') ?>">
                                <span class="fs-8">
                                    Subscribe
                                </span>
                            </a>
            ...
            <div class="pt-5">
                <hr class="text-white">
                <h6 class="text-white fs-8">Copyright - 2023 - Developed by NaZMa Office</h6>
            </div>
        </div>
    </div>
</footer>